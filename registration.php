...
$_user_location	= 'public';
	...
	if (isset($_POST['submit'])) {
		...
		if (!$msg->containsErrors()) {
			...
			$_POST['password_hidden'] = $addslashes($_POST['password_hidden']);
			...
			$sha1_pass;
			if (strlen($_POST['password_hidden']) < 40) { // <noscript> on client end, encrypt on server side
				$sha1_pass = sha1($POST_['password_hidden']);
			} else { // sha-1 ok
			...
			$sql = "INSERT INTO ".TABLE_PREFIX."members VALUES (0,'$_POST[login]','$sha1_pass','$_POST[email]','$_POST[website]','$_POST[first_name]','$_POST[last_name]', '$dob', '$_POST[gender]', '$_POST[address]','$_POST[postal]','$_POST[city]','$_POST[province]','$_POST[country]', '$_POST[phone]',0,'$start_prefs', NOW(),'$_SESSION[lang]')";
			$result = mysql_query($sql, $db);
