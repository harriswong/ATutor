...
if (isset($_REQUEST['to_tile']) && !isset($_POST['cancel'])) {
	...
	header('Location: '.AT_TILE_IMPORT. '?cp='.urlencode(AT_BASE_HREF. 'tools/imscc/ims_export.php?cid='.$cid.'&c='.$_SESSION['course_id'].'&m='.$m));
	exit;
...
require(AT_INCLUDE_PATH.'imscc/ims_template.inc.php');				/* for ims templates + print_organizations() */
