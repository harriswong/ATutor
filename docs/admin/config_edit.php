...
if (!isset($_POST['submit'])) {
	...
	$defaults['enable_sco'] = defined('AT_ENABLE_SCO') && AT_ENABLE_SCO ? 'TRUE' : 'FALSE';
...
<div class="input-form">
	...
	<div class="row">
		<?php echo _AT('enable_sco_rte'); ?><br />
		<input type="radio" name="enable_sco" value="TRUE" id="sco_y" <?php if($defaults['enable_sco']=='TRUE') { echo 'checked="checked"'; }?> <?php echo $disabled; ?> /><label for="sco_y"><?php echo _AT('enable'); ?></label> <input type="radio" name="enable_sco" value="FALSE" id="sco_n" <?php if($defaults['enable_sco']=='FALSE' || empty($defaults['enable_sco'])) { echo 'checked="checked"'; }?> <?php echo $disabled; ?> /><label for="sco_n"><?php echo _AT('disable'); ?></label>
	</div>
