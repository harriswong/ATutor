...
<h3>Exporting Content</h3>
	...
	<p>To export content, select the scope by choosing an option from the <em>What to export</em> menu. Then, using <kbd>Export</kbd> will generate a download through your browser. Optionally, you can choose to export the content directly to the <a href="../instructor/4.4.tile_repository.php">TILE content repository</a> if you have a TILE authoring account.</p>
