...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="form">
	...
	<div class="input-form" style="max-width: 400px;">
		...
		<div class="row">
			...
			<input id="password" name="password" type="password" size="20" maxlength="15" value="<?php echo stripslashes(htmlspecialchars($_POST['password'])); ?>" /><br />
		...
		<div class="row">
			...
			<input id="password2" name="password2" type="password" size="20" maxlength="15" value="<?php echo stripslashes(htmlspecialchars($_POST['password2'])); ?>" />
		</div>
