...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="form">
	...
	<div class="input-form" style="max-width: 400px;">
		...
		<div class="row">
			...
			<input id="old_password" name="old_password" type="password" size="30" maxlength="15" value="<?php echo stripslashes(htmlspecialchars($_POST['old_password'])); ?>" /><br />
		</div>

		<div class="row">
			<div class="required" title="<?php echo _AT('required_field'); ?>">*</div><label for="password"><?php echo _AT('password'); ?></label><br />
			<input id="password" name="password" type="password" size="30" maxlength="15" value="<?php echo stripslashes(htmlspecialchars($_POST['password'])); ?>" /><br />
		...
		<div class="row">
			...
			<input id="password2" name="password2" type="password" size="30" maxlength="15" value="<?php echo stripslashes(htmlspecialchars($_POST['password2'])); ?>" />
		</div>
