...
<head>
	...
	<link rel="stylesheet" href="<?php echo $this->base_path.'themes/'.$this->theme; ?>/fha_styles.css" type="text/css"/>
	<!--[if IE]>
...
<script language="JScript" type="text/jscript" src="<?php echo $this->base_path.'themes/'.$this->theme; ?>/popFix.js"></script>
