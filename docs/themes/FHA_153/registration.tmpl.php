...
<div class="input-form">
	...
	<?php if (!$_POST['member_id'] && defined('AT_MASTER_LIST') && AT_MASTER_LIST && !admin_authenticate(AT_ADMIN_PRIV_USERS, TRUE)): ?>
		...
		<div class="row">
			...
			<br />
			<span style="background-color:pink"><strong><?php echo _AT('image_validation_text2'); ?><br /></strong></span>
		</div>
	<?php endif; ?>
	...
	<div class="row">
		...
		<?php else: ?>		
			...
			<input id="login" name="login" type="text" maxlength="20" size="25" value="<?php echo stripslashes(htmlspecialchars($_POST['login'])); ?>" /><br />
			<span style="background-color:pink"><strong>&middot; <?php echo _AT('contain_only'); ?><br />
				   &middot; <?php echo _AT('20_max_chars'); ?></strong></span>
		<?php endif; ?>
	</div>
	...
	<?php if (!admin_authenticate(AT_ADMIN_PRIV_USERS, TRUE) || !$_POST['member_id']): ?>
		<div class="row">
			...
			<span style="background-color:pink"><strong>&middot; <?php echo _AT('combination'); ?><br />
				   &middot; <?php echo _AT('15_max_chars'); ?></strong></span>
		</div>
		<div class="row">
	...
	<div class="row">
		...
		<br /><input type="checkbox" id="priv" name="private_email" value="1" <?php if ($_POST['private_email']) { echo 'checked="checked"'; } ?> /><label for="priv"><?php echo _AT('keep_email_private');?></label>
