...
INSERT INTO `courses` VALUES (1, 1, 0, 'top', 'public', NOW(), 'Welcome Course', '', 0, '-2', '-3', 0, '', '', '', '', '', '', 'en', 0, 'books.jpg', 'forum/list.php|glossary/index.php|file_storage/index.php|chat/index.php|tile.php|faq/index.php|links/index.php|tools/my_tests.php|sitemap.php|export.php|my_stats.php|polls/index.php|directory.php|blogs/index.php|reading_list/index.php|groups.php','forum/list.php|glossary/index.php|file_storage/index.php','menu_menu|related_topics|users_online|glossary|search|poll|posts', '', '');
