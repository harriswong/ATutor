...
<script language="JavaScript">
  function crypt_sha1() {
  	document.form.password_hidden.value = hex_sha1(document.form.password.value);
...
<tr><td height="1" class="public-row" colspan="2"></td></tr>
<tr>
	<td class="public-row" colspan="2" align="center">
	<input type="hidden" name="password_hidden">
	<input type="submit" class="button" onClick="return crypt_sha1();" value=" <?php echo _AT('submit'); ?>" name="submit" /> - <input type="submit" name="cancel" class="button" value=" <?php echo _AT('cancel'); ?> " /></td>
</tr>
</table>
</form>
