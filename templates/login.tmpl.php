...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="form">
	...
	<p class="public-text" align="center"><br />
	<input type="hidden" name="form_password_hidden">
	<input type="submit" name="submit" class="button" onClick="return crypt_sha1();" value="<?php echo _AT('login'); ?>" /> - <input type="submit" name="cancel" class="button" value="<?php echo _AT('cancel'); ?>" /></p>
